...
const short nxgrs0=3,nygrs0=2;
#include "shared.h"

void initMGR(TGraph *grs[nxgrs0][nygrs0],TMultiGraph *mgr){
	const short markers[]={71,73};//open
	const short colors[]={4,2,1};
	const short lines[]={2,5};
	for(short i=0;i<nxgrs0;i++){//different kinds of nucleon-gaps
...
void pairGap(short z0=50,short n0=0){//3 kind of nucleon-pair gaps of a series of isotopes/isotones
	...
	setLines(grs,nxgrs0,nygrs0,ls,xLow,xHigh,yLow,yHigh);
